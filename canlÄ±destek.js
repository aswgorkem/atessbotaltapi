...
const emoji = message.client.emojis.get('📞');
      ...
      let destekKanal = "577758515289128970";
    ...
    client.channels.get(destekKanal).send('** Destek Çağrısına Bağlanmak İçin** `canlıdestek-bağlan` **Yazınız. İptal Etmek İçin** `canlıdestek-iptal` **Yazınız.**')
